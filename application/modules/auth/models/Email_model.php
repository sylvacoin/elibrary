...
//        $config['smtp_port']	= "25";
		...
		$system_name	=	$this->db->get_where('settings' , array('type' => 'school_name'))->row()->description;
		if($from == NULL)
                $from	= $this->db->get_where('settings' , array('type' => 'school_support_email'))->row()->description;
		...
		$msg	=	$msg."<br /><br /><br /><br /><br /><br /><br /><hr /><center><a href=\"http://www.dimconnect.com\"> &copy; ". date('Y')." Dimconnect School Management System </a></center>";
