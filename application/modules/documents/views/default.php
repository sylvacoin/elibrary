<div class="row">
	...
	<div class="white-box">
		...
		<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
			...
			<a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-cloud-upload"></i> Upload document</a></li>
		    <li role="presentation" class="">
			<a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-book"></i> View documents</a></li>
		</ul>
